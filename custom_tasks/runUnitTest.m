...
%runUnitTest   Simulink Project custom task for running MATLAB unit tests
%
% Input arguments:
%  file - string - The absolute path to a MATLAB unit test.
%  When you run this function as a custom task, Simulink Project provides 
%  the file input for each selected file.
%
% Output arguments:
%  report - string - A summary report of the test results. The Simulink 
%  Project displays the result in the Custom Task Results column.
%
